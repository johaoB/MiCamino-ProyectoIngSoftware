...
const ProfesorPage = () => {
  ...
  return (
    <div style={s.page}>
      <div style={{...s.glow, background: '#f59e0b'}} />
      ...
      <main style={s.main}>
        ...
        {vista === 'home' && (
          <>
            <div style={{...s.iconBox, borderColor:'#f59e0b20', background:'#f59e0b12'}}>
            ...
            <button style={{...s.primaryBtn, background:'#f59e0b'}} onClick={cargarEstudiantes} disabled={loading}>
